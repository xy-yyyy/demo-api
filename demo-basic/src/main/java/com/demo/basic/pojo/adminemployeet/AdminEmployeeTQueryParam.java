package com.demo.basic.pojo.adminemployeet;
 ...
 * @Author: sunYF
 * @Description:
 * @Date: Create in 13:00 2020/8/28
 */
@Data
@ApiModel(value = "员工信息查询参数", description = "员工信息查询参数")
public class AdminEmployeeTQueryParam {
